...
function QuizCard({singleQuiz}) {
    ...
    return (
        <div className='rounded-[10px] flex flex-col gap-2 border border-gray-300 bg-white p-4'>
            {/* Image Container */}
            <div className='relative bg-green-700 w-full h-32 flex justify-center items-center rounded-[10px]'>
                {/* More Option Icon */}
            ...
            <div className='flex gap-3'>
                ...
                <div className='flex gap-1 items-center'>
                    <Image src='/target-777.png' alt='Target Icon' width={20} height={10} />
